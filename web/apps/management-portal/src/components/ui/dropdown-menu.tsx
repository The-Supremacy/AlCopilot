...
>(({ className, children, checked, ...props }, ref) => (
  ...
  >
    <span
      aria-hidden="true"
      className={cn(
        'absolute left-2 flex h-4 w-4 items-center justify-center rounded border border-border bg-background text-primary',
        checked ? 'border-primary bg-primary/10' : 'text-transparent',
      )}
    >
