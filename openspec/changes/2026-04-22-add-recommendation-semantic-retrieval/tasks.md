...
- [x] 2.2 Build one retrieval point per facet (`name`, `ingredient`, `description`) and aggregate Qdrant hits back to drink-level semantic signals.
...
- [x] 2.4 Feed semantic signals into request-intent enrichment and deterministic candidate ranking without changing hard exclusion or grouping ownership.
...
- [x] 3.1 Add unit tests for facet projection building, hit aggregation, and weighting.
- [x] 3.2 Add tests for descriptive prompts and typo-tolerant prompts such as "sparkly sweet" and slight ingredient or drink misspellings.
